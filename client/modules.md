...
<!-- Теги: AMD, модули, RequireJS, define, attributes, messages, sandbox, diff, жизненный цикл, ProcessDesigner -->
...
| Документ | Назначение |
| -------- | ---------- |
| [client-module-overview.md](client-module-overview.md) | Карта Client Module Dive и ключевые сценарии |
| [client-amd-module-anatomy.md](client-amd-module-anatomy.md) | AMD `define`, dependencies, `entitySchemaName`, `mixins`, `methods` |
...
| [client-sandbox-messages.md](client-sandbox-messages.md) | sandbox `publish/subscribe`, PTP, BROADCAST |
...
| [client-troubleshooting.md](client-troubleshooting.md) | Диагностика AMD, sandbox, diff, services и grid |

Для специализированных AMD-модулей дизайнера процессов см.
[Process Designer UI Overview](../server/process-designer-ui-overview.md):
там отдельно разобраны `ProcessSchemaElementPropertiesEdit`, property pages,
PTP sandbox contracts и mapping modules.
