...
Подробная документация по файловой подсистеме вынесена в отдельный пакет:

| Документ | Назначение |
| -------- | ---------- |
| [file-overview.md](file-overview.md) | Карта File Storage Dive |
| [file-schema-model.md](file-schema-model.md) | `File`, `{Entity}File`, storage metadata |
| [file-repository-api.md](file-repository-api.md) | `FileRepository`, `IFile`, `EntityFileLocator` |
| [file-upload-download.md](file-upload-download.md) | upload/download flows, chunk upload |
| [file-client-detail.md](file-client-detail.md) | `FileDetailV2`, `ConfigurationFileApi`, `FileDownloader` |
| [file-versioning-deletion.md](file-versioning-deletion.md) | versioning, sanitize, cascade delete |
| [file-security-limits.md](file-security-limits.md) | rights, `MaxFileSize`, file security settings |
| [file-pattern-catalog.md](file-pattern-catalog.md) | Каталог реальных file-паттернов |
| [file-troubleshooting.md](file-troubleshooting.md) | Диагностика upload/download/delete |
