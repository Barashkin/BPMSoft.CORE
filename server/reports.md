...
## Reports/Printables Dive

Для детального разбора отчётов используйте пакет документов:

| Документ | Когда открывать |
| -------- | --------------- |
| [Reports Printables Overview](reports-overview.md) | общая карта подсистемы отчётов |
| [Reports Engine API](reports-engine-api.md) | `IReportEngine`, `ReportEngine`, `ReportEngineService` |
| [Reports Word](reports-word.md) | Word printable, макросы, PDF conversion |
| [Reports FastReport](reports-fastreport.md) | `.frx`, data sources, PDF generation |
| [Reports Client Print UI](reports-client-print-ui.md) | меню печати, `PrintReportUtilities`, client services |
| [Reports Templates Storage](reports-templates-storage.md) | `SysModuleReport`, `StoredReport`, форматы |
| [Reports Async Generation](reports-async-generation.md) | async PDF, callback, уведомления |
| [Reports Security And Limits](reports-security-limits.md) | права, форматы, лимиты шаблонов |
| [Reports Pattern Catalog](reports-pattern-catalog.md) | рабочие паттерны из `Autogenerated/Src` |
| [Reports Troubleshooting](reports-troubleshooting.md) | диагностика генерации и скачивания |
...
- [Reports Printables Overview](reports-overview.md)
