...
Для подробной работы с `EntitySchemaQuery` см. ESQ Dive:

- [esq-overview.md](esq-overview.md) - обзор ESQ и границы применения
- [esq-columns-and-paths.md](esq-columns-and-paths.md) - колонки, lookup path, bracket path, alias
- [esq-filters.md](esq-filters.md) - фильтры, группы, функции
- [esq-joins-and-subqueries.md](esq-joins-and-subqueries.md) - reverse links и `CreateExistsFilter`
- [esq-performance.md](esq-performance.md) - `RowCount`, права, display values, anti-patterns
- [esq-pattern-catalog.md](esq-pattern-catalog.md) - реальные ESQ-паттерны из решения
- [esq-troubleshooting.md](esq-troubleshooting.md) - диагностика ESQ-проблем

## Entity Schema Dive

Этот документ остаётся обзором. Детальное описание схем вынесено в небольшой пакет:

| Документ | Что раскрывает |
| -------- | -------------- |
| [entity-schema-overview.md](entity-schema-overview.md) | карта пакета, структура schema-файла, связь с ESQ и EventsProcess |
...
| [entity-schema-inheritance.md](entity-schema-inheritance.md) | `BaseEntity`, `BaseLookup`, package layers и `ExtendParent` |
| [entity-schema-folders-tags-files.md](entity-schema-folders-tags-files.md) | `BaseFolderSchema`, `BaseItemInFolderSchema`, `BaseEntityInTagSchema`, `FileSchema` |
